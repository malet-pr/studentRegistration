...
insert into courses (code,subject_id,time,day,max_capacity) values ('AA-111-01', 2, '9-11 AM', 'Mon-Thu', 2);
insert into courses (code,subject_id,time,day,max_capacity) values ('AB-121-02', 3, '1-3 PM', 'Mon-Wed-Thu', 50);
insert into courses (code,subject_id,time,day,max_capacity) values ('BB-102-03', 4, '9-11 AM', 'Tue-Fri-Sat', 50);
insert into courses (code,subject_id,time,day,max_capacity) values ('BD-101-01', 5, '3-5 PM', 'Tue-Fri', 15);
insert into courses (code,subject_id,time,day,max_capacity) values ('CA-100-02', 6, '11-1 AM/PM', 'Wed-Sat', 0);
